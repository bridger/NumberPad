...
+ (DDExpression *)expressionFromString:(NSString *)expressionString error:(NSError **)error;

+ (DDExpression *)numberExpressionWithNumber:(NSNumber *)number;
+ (DDExpression *)functionExpressionWithFunction:(NSString *)function arguments:(NSArray *)arguments error:(NSError **)error;
+ (DDExpression *)variableExpressionWithVariable:(NSString *)variable;
